...
public class Lab2263 {
	public static void main(String[] args) {
		...
		strNum1 = JOptionPane.showInputDialog(null, "Please input a: ", "Input the first number",
				JOptionPane.INFORMATION_MESSAGE);

		strNum2 = JOptionPane.showInputDialog(null, "Please input b: ", "Input the second number",
				JOptionPane.INFORMATION_MESSAGE);

		strNum3 = JOptionPane.showInputDialog(null, "Please input c:", "Input the second number",
				JOptionPane.INFORMATION_MESSAGE);
