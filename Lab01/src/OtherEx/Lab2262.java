...
public class Lab2262 {
	public static void main(String[] args) {
		...
		strNum1 = JOptionPane.showInputDialog(null, "Please input a11: ", "Input the first number",
				JOptionPane.INFORMATION_MESSAGE);

		strNum2 = JOptionPane.showInputDialog(null, "Please input a12: ", "Input the second number",
				JOptionPane.INFORMATION_MESSAGE);

		strNum3 = JOptionPane.showInputDialog(null, "Please input a21:", "Input the second number",
				JOptionPane.INFORMATION_MESSAGE);

		strNum4 = JOptionPane.showInputDialog(null, "Please input a22: ", "Input the second number",
				JOptionPane.INFORMATION_MESSAGE);

		strNum5 = JOptionPane.showInputDialog(null, "Please input b1: ", "Input the second number",
				JOptionPane.INFORMATION_MESSAGE);

		strNum6 = JOptionPane.showInputDialog(null, "Please input b2: ", "Input the second number",
				JOptionPane.INFORMATION_MESSAGE);
